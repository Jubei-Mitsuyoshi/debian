...
######## Install Recon-NG
function installreconng {
if [ ! -f /opt/recon-ng/recon-ng.py ]; then
	...
	echo -e "Do you want to install it ? (Y/N)"
		...
		echo -e "\e[32m[-] Recon-NG already installed !\e[0m"
	fi
}
...
select menusel in "Bleeding Edge Repos" "Bleachbit" "Hackpack" "Google Chrome" "Flash" "Recon-NG" "Smbexec" "Xssf" "Ettercap 0.76" "AngryIP Scanner" "Terminator" "Xchat" "Unicornscan" "Nautilus Open Terminal" "Simple-Ducky" "Subterfuge" "Ghost-Phisher" "Java" "Install All" "Back to Main"; do
case $menusel in
	"Bleeding Edge Repos")
		bleedingedge
		pause 
